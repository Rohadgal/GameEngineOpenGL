...
namespace GL
{
	...
	{
		assert(SDL_Init(SDL_INIT_EVERYTHING) == 0 && "No se pudo inicializar SDL");//TODO: asser deberia ser un error
		m_WindowHandle = SDL_CreateWindow(nombre, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, width, height, SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL);//Para crear la ventana
